...
In de CTA-variant is dat groen daarom `#1B7A48` geworden: `--color-accent` uit
de merklaag. Die kleur bestaat daar juist omdát het logogroen op wit te licht is
(2,69:1), dus dit is dezelfde afweging die het hele merk al maakt. Gemeten over
elke pixel van beide bitmaps: **5,35:1**, en geen enkele pixel onder 4,5.

...
def patroonhero(nr, ident, label, titel):
    ...
    return (f'  <section class="paginahero paginahero--patroon" id="s{nr}-{ident}">\n'
            ...
            '      <img src="assets/patronen/hero-patroon-v5-1440.webp" '
            'srcset="assets/patronen/hero-patroon-v5-720.webp 720w, '
            'assets/patronen/hero-patroon-v5-1000.webp 1000w, '
            'assets/patronen/hero-patroon-v5-1440.webp 1440w" '
